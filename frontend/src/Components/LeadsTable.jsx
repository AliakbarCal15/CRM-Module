            ...
            {currentLeads.map((lead) => {
              ...
              return (
                <tr key={lead._id}>
                  ...
                  >
                    <span className="text-blue-600 cursor-pointer font-medium">{fullName}</span>
                  </td>
                  <td className="px-4 py-2 border">{email}</td>
                  <td className="px-4 py-2 border">{lead.phone || 'N/A'}</td>
                  <td className="px-4 py-2 border capitalize">{lead.status || 'N/A'}</td>
                  <td className="px-4 py-2 border text-center space-x-3 relative group">
                    <button onClick={() => onViewDetails(lead)} className="hover:text-blue-600">
                      <EyeIcon className="h-5 w-5" />
                    </button>
                    <button onClick={() => onEdit(lead)} className="hover:text-yellow-600">
